...
void ThongTinChung(){
	...
	TextColor(92);	
	gotoXY(65,5);printf("                        ss              \n");	TextColor(90);	
	gotoXY(65,6);printf("           sssssssssssssss              \n");	
	gotoXY(65,7);printf("        ssss      ssssssss              \n");	
	gotoXY(65,8);printf("      sss     ssssss s ss              \n");	
	gotoXY(65,9);printf("     s    sssssssss  s  ss              \n");	
	gotoXY(65,10);printf("   ss   sssssssss   s   ss              \n");	
	gotoXY(65,11);printf("  ss  ssssssssss   s    ss              \n");	
	gotoXY(65,12);printf("  sssssssssss     ss     ss    ssssss   \n");	
	gotoXY(65,13);printf("sssssss          ss       ss ssssssssss \n");TextColor(92);	
	gotoXY(65,14);printf("         sssss  sss        s  sssssssss \n");	
	gotoXY(65,15);printf("      sssssssss ssssssssssssssssssssssss\n");	
	gotoXY(65,16);printf("     ssssssssssss  sssss  ssssssssssssss\n");	
	gotoXY(65,17);printf("    sss  ssssssssssssssss  sssssssss  ss\n");	
	gotoXY(65,18);printf("    ss   sssssssssssssssss sssssssss  ss\n");	
	gotoXY(65,19);printf("    ss  ssssssssssssssssss sssssssss ss \n");	
	gotoXY(65,20);printf("    sss ssssssssssssssssss sssssssssss  \n");	
	gotoXY(65,21);printf("    sss  ssssssssssssssss sssssssssss   \n");	
	gotoXY(65,22);printf("     sssssssssssssssssss  sssssssss     \n");	
	gotoXY(65,23);printf("     sssssssssssssssssss                \n");	
	gotoXY(65,24);printf("       sssssssssssssss                  \n");	
	gotoXY(65,25);printf("          ssssssssss                    \n");	
	gotoXY(96,12);printf("ssssss");
	gotoXY(94,13);printf("ssssssssss");	TextColor(82);	
	gotoXY(89,5);printf("ss");
	gotoXY(88,6);printf("sss");
	gotoXY(87,7);printf("ssss");
	gotoXY(86,8);printf("ss ss");	
	gotoXY(86,9);printf("s  ss");
	gotoXY(85,10);printf("s   ss");
	gotoXY(84,11);printf("s    ss");	
	gotoXY(83,12);printf("ss     ss");
	gotoXY(83,12);printf("ss     ss");
	gotoXY(82,13);printf("sss        s");	
	gotoXY(89,4);printf("ss");
	gotoXY(89,3);printf("ss");
	gotoXY(88,2);printf("ss");
	gotoXY(87,1);printf("ss");
	gotoXY(87,0);printf("s");		
